...
# Download YoloV11 Pose Estimation Pretrained Models (*.pt) (Not official)

 see https://github.com/YapaLab/yolo-face?tab=readme-ov-file
...
$ yolo export model=yolo11s-face.pt format=onnx dynamic=True opset=20 nms=True device=0
```
...
```
$ /usr/src/tensorrt/bin/trtexec --onnx=yolo11s-face.onnx --saveEngine=yolo11s-face.engine --fp16 --minShapes="images:1x3x640x640" --optShapes="images:1x3x1088x1920" --maxShapes="images:1x3x1440x2560" 
